...
Usage (benchmark mode - default labels):
    python -m testset.phrasebank_benchmark
    python -m testset.phrasebank_benchmark --max-samples 200

Usage (benchmark mode - with tuned config):
    python -m testset.phrasebank_benchmark --config about_outlook__outlook
    python -m testset.phrasebank_benchmark --config about_outlook__outlook --max-samples 200

Usage (label tuning mode — K-fold CV with 112 template x label configs):
    python -m testset.phrasebank_benchmark --mode tune
    python -m testset.phrasebank_benchmark --mode tune --stage full
    python -m testset.phrasebank_benchmark --mode tune --stage coarse
    python -m testset.phrasebank_benchmark --mode tune --n-folds 5 --test-ratio 0.20
    python -m testset.phrasebank_benchmark --mode tune --resume
    python -m testset.phrasebank_benchmark --mode tune --max-samples 50  # smoke test
"""
