...
Usage:
    python -m testing.evaluation.split_test_set
    python -m testing.evaluation.split_test_set --test-set path/to/test_set.json
    python -m testing.evaluation.split_test_set --find-split   # only show search results
"""
